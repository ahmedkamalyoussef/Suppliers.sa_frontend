...
function middleware(request) {
    ...
    // ==========================================
    if (pathname === "/login" || pathname === "/register" || pathname.startsWith("/reset-password") || pathname === "/forgot-password") {
        if (token && userType) {
            if (userType === "admin") {
    ...
    if (token && (userType === "admin" || userType === "super_admin")) {
        ...
        if (!pathname.startsWith("/admin") && !pathname.startsWith("/api") && !pathname.startsWith("/_next") && !pathname.includes(".") && // Skip static files
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2Fhome%2Fkemo%2FDevelopment%2FWork%2Fmostaql%2FSupplier.sa1&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFhcGl8X25leHRcXC9zdGF0aWN8X25leHRcXC9pbWFnZXxmYXZpY29uLmljb3wuKlxcLnBuZ3wuKlxcLmpwZ3wuKlxcLmpwZWd8LipcXC5naWZ8LipcXC5zdmcpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hYXBpfF9uZXh0L3N0YXRpY3xfbmV4dC9pbWFnZXxmYXZpY29uLmljb3wuKlxcLnBuZ3wuKlxcLmpwZ3wuKlxcLmpwZWd8LipcXC5naWZ8LipcXC5zdmcpLiopIn1d&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFhcGl8X25leHRcXC9zdGF0aWN8X25leHRcXC9pbWFnZXxmYXZpY29uLmljb3wuKlxcLnBuZ3wuKlxcLmpwZ3wuKlxcLmpwZWd8LipcXC5naWZ8LipcXC5zdmcpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hYXBpfF9uZXh0L3N0YXRpY3xfbmV4dC9pbWFnZXxmYXZpY29uLmljb3wuKlxcLnBuZ3wuKlxcLmpwZ3wuKlxcLmpwZWd8LipcXC5naWZ8LipcXC5zdmcpLiopIn1dfQ%3D%3D!
