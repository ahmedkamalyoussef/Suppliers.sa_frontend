                      ...
                      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        <div className="max-h-80 md:max-h-96 overflow-y-auto">
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-px bg-gray-200">
                            ...
                            {Array(
                              4 - (business.productsAndServices.length % 4)
                            )
                              .fill(0)
                              .map(
                                (_, index) =>
                        ...
                        <div className="bg-blue-50 px-3 py-2 md:px-4 md:py-3 border-t border-blue-200">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                            <div className="flex items-center space-x-1 md:space-x-2 text-xs md:text-sm text-blue-700">
                              ...
                              <span>
                                {t("businessProfile.customersCanSearch")}
                              </span>
                            </div>
                            <div className="text-xs md:text-sm text-blue-600 font-medium">
                              {t(
                                "businessProfile.totalProductsServices"
                              ).replace(
                                "{{count}}",
                                String(business.productsAndServices.length)
                              )}
                          ...
                          >
                            <div className="aspect-[4/3] overflow-hidden">
                              <img
                                src={image.url}
                                alt={
                                  image.caption || `Business photo ${index + 1}`
                                }
...
Best regards,"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between pt-3 md:pt-4 border-t border-gray-200 gap-3">
                          <div className="flex items-center space-x-2 md:space-x-4">
                            <div className="flex items-center space-x-1 md:space-x-2 text-xs text-gray-600">
                              ...
                              <span>
                                {t("businessProfile.businessHoursInline")}
                              </span>
                            </div>
                          </div>
                    ...
                    <div className="p-4 md:p-8 text-center">
                      ...
                      <p className="text-xs md:text-sm text-gray-500 mb-4 md:mb-6">
                        They typically respond within 24 hours during business
                        hours
                      </p>
                        ...
                        <div className="flex items-start space-x-2 md:space-x-3">
                          ...
                          <div>
                            ...
                            <ul className="text-xs text-blue-700 space-y-1">
                              ...
                              <li>
                                • Reviews are typically approved within 24-48
                                hours
                              </li>
                              <li>
                              ...
                              <li>
                                • The business owner will be notified of your
                                review
                              </li>
                            </ul>
                          </div>
            ...
            {showReviewModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 md:p-4 z-50">
                <div className="bg-white rounded-xl md:rounded-2xl shadow-2xl w-full max-w-lg">
                  {!showThankYou ? (
                    <>
                      {/* Review Header */}
                      <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-200 bg-gray-50">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <h2 className="text-lg md:text-xl font-bold text-gray-800">
                              {t("businessProfile.writeReview")}
                            </h2>
                            <p className="text-sm text-gray-600">
                              {t("businessProfile.shareExperience")}
                            </p>
                          </div>
                        </div>
                        <button
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          <button
                            type="button"
                            onClick={resetReviewForm}
                            className="px-6 py-3 border border-gray-300 rounded-full hover:bg-gray-50 font-medium transition-colors"
                          >
                            {t("businessProfile.cancel")}
                          </button>
                          <button
                            type="submit"
                            disabled={!selectedRating || !reviewText.trim()}
                            className="bg-yellow-400 hover:bg-yellow-500 disabled:bg-gray-300 text-white px-6 py-3 rounded-full font-semibold transition-colors disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                          >
                            <i className="ri-send-plane-line"></i>
                            <span>{t("businessProfile.submitReview")}</span>
                          </button>
