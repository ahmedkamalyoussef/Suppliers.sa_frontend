...
export default function AdminAnalytics() {
  ...
  const canViewAnalytics = user?.role === "super_admin" || hasPermission("analytics_view");
  const canExportAnalytics = user?.role === "super_admin" || hasPermission("analytics_export");
