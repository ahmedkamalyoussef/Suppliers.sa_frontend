                  ...
                  {language === "ar" ? (
                    <div className="space-y-4 text-gray-700 text-sm">
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          <li>
                            ...
                            المعلومات الأساسية للشركات والموردين لتسهيل التواصل
                            التجاري.
                          </li>
                          <li>
                            <strong>مزودي الخدمات:</strong> مع شركات الطرف
                            الثالث التي تساعدنا في تشغيل المنصة.
                          </li>
                          <li>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          <li>
                            <strong>الوصول:</strong> طلب نسخة من معلوماتك
                            الشخصية
                          </li>
                          <li>
                            <strong>التصحيح:</strong> تحديث المعلومات غير
                            الصحيحة
                          </li>
                          <li>
                    ...
                    <div className="space-y-4 text-gray-700 text-sm">
                      <p>
                        Welcome to Supplier.sa. We at Supplier Establishment
                        take your privacy very seriously, whether you are a
                        supplier or a business. This policy explains how we
                        collect, use, and protect your personal information.
                        Your use of the platform indicates your consent to this
                        policy.
                      </p>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          ...
                          <li>
                            ...
                            customize your experience, remember your
                            preferences, and analyze how you use the platform.
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          ...
                          <li>
                            ...
                            user behavior, understand their needs, and develop
                            new features.
                          </li>
                          <li>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          <li>
                            ...
                            about businesses and suppliers is shared to
                          ...
                          <li>
                            <strong>In Case of Ownership Transfer:</strong> In
                            the event of selling or merging the platform with
                            another company.
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          ...
                          <li>
                            <strong>Restrict Processing:</strong> Restrict use
                            of your information
                          </li>
                          <li>
                            <strong>Data Portability:</strong> Request transfer
                            of your information to a third party
                          </li>
                          <li>
                  ...
                  {language === "ar" ? (
                    <div className="space-y-4 text-gray-700 text-sm">
                      ...
                      <div>
                        ...
                        <p>
                          بالوصول إلى أو استخدام منصة سبلاير، فإنك تقبل وتوافق
                          على الالتزام بهذه الشروط. إذا كنت لا توافق على هذه
                          الشروط، يجب عليك التوقف عن استخدام المنصة فوراً.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          منصة سبلاير هي منصة إلكترونية تربط بين الشركات
                          والموردين في المملكة العربية السعودية. الهدف هو تسهيل
                          التواصل التجاري وتوسيع فرص الأعمال.
                        </p>
                      </div>
                    ...
                    <div className="space-y-4 text-gray-700 text-sm">
                      <p>
                        By using Supplier.sa, you agree to comply with these
                        terms and conditions. If you do not agree to these
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          businesses and suppliers in the Kingdom of Saudi
                          Arabia. The goal is to facilitate commercial
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          <li>
                            Must be a real and legally registered business
                          </li>
                      ...
                      <div>
                        ...
                        <p>
                          The following content is prohibited from being
                          published or shared:
                        </p>
                        <ul className="list-disc list-inside space-y-2 ml-4">
