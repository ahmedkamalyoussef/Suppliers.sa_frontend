export const translations = {
  ...
  ar: {
    ...
    searchStepDesc:
      "استخدم أدوات البحث القوية للعثور على ما تحتجه بالضبط في منطقتك.",
    ...
    searchRequest: {
      ...
      submitRequestDesc:
        "قدم طلباً ودع الموردين المعتمدين يأتون إليك بعروض تنافسية",
    ...
    subscriptionFAQ: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "نعم! ثبّت مواقع غير محدودة على الخريطة، أدر كل فرع بشكل منفصل مع معلومات تواصل وساعات عمل فريدة، تتبع الأداء حسب الموقع، وساعد العملاء على إيجاد فرع لهم تلقائياً.",
        },
        {
    ...
    subscriptionFeatures: {
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "احصل على رؤى تفصيلية حول أداء ملفك وتفاعل العملاء ونمو النشاط من خلال لوحة تحكم متقدمة.",
          benefits: [
            "تتبع أداء الملف",
    ...
    successStories: {
      ...
      alNourDesc:
        "زادت عملاء الشركات بنسبة 60% بعد تحسين ملفهم وترقي للباقة المميزة.",
