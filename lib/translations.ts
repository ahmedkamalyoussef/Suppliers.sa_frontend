  ...
  en: {
    ...
    businessManagement: {
      ...
      form: {
        ...
        additionalPhonesDescription:
          "Add additional contact numbers for different departments or services",
      },
      details: {
        businessType: "Business Type",
  ...
  ar: {
    ...
    businessManagement: {
      ...
      form: {
        ...
        additionalPhonesDescription:
          "أضف أرقام اتصال إضافية لأقسام أو خدمات مختلفة",
      },
      details: {
        businessType: "نوع النشاط",
      ...
      verification: {
        ...
        supportedFormats:
          "التنسيقات المدعومة: JPG, PNG, PDF (الحد الأقصى 5 ميجابايت)",
    ...
    subscription: {
      ...
      requiredMessage:
        "هذه الميزة تتطلب اشتراكاً مميزاً أو مؤسسياً للوصول إليها.",
      upgrade: "ترقية الآن",
      cancel: "إلغاء",
    },
    ...
    aboutPage: {
      ...
      communitySupportBody:
        "ندعم المجتمعات عبر أولوية الشركات سعودية وخلق فرص عمل والمساهمة في تنمية كل منطقة.",
    ...
    register: {
      ...
      step1: {
        ...
        verifyAccountSubtitle:
          "أرسلنا لك رمز تحقق مكون من 4 أرقام لتحقق من هويتك",
    ...
    subscriptionFAQ: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "يظهر نشاطك التجاري بشكل بارز في قسم المميزين بالصفحة الرئيسية، ويحصل على تفضيل أولوية في جميع نتائج البحث، ويظهر أولاً عندما يتصفح العملاء فئتك. هذا يزيد بشكل كبير من ظهورك ويجذب المزيد من العملاء لنشاطك التجاري.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "معظم الشركات ترى زيادة في الاستفسارات خلال 24-48 ساعة من التفعيل. الموضع المميز وحالة التوثيق تطبق فوراً، وفرق خدمة العملاء لدينا يساعد في تحسين ملفك لتوليد أقصى عدد من العملاء من اليوم الأول.",
        },
      ],
      contact: {
